...
class BankAccountConditionCounterTest {
    ...
    public void testCountWithBalanceGreaterThan() {
        ...
        assertEquals(3, new BankAccountConditionCounter().conditionCounter(bankAccounts, 100));
        assertEquals(0, new BankAccountConditionCounter().conditionCounter(bankAccounts, 400));
    }
}