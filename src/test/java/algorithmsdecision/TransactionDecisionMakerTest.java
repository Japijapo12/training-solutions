...
import static org.junit.jupiter.api.Assertions.*;
    ...
    public class TransactionDecisionMakerTest {
        ...
        List<Transaction> transactions = Arrays.asList(
                new Transaction("123-324-123", TransactionOperation.CREDIT, 2000, dateTime1, Status.SUCCEEDED),
                new Transaction("133-324-123", TransactionOperation.DEBIT, 300, dateTime2, Status.SUCCEEDED),
                new Transaction("143-324-123", TransactionOperation.DEBIT, 2000, dateTime3, Status.SUCCEEDED)
        );
