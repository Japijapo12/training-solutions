...
public class TransactionExecutorTest {
    ...
    List<Transaction> transactions = Arrays.asList(
            new Transaction("123-324-123", TransactionOperation.CREDIT, 2000, LocalDateTime.MIN, Status.SUCCEEDED),
            new Transaction("133-324-123", TransactionOperation.DEBIT, 200, LocalDateTime.MIN, Status.SUCCEEDED),
            new Transaction("143-324-123", TransactionOperation.DEBIT, 2000, LocalDateTime.MIN, Status.SUCCEEDED)
    );
