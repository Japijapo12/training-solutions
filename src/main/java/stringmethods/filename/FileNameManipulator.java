...
public class FileNameManipulator {
    ...
    public char findLastCharacter(String str) {
        ...
        return str.charAt(str.length() - 1);  // 0-val kezdődik a számozás
    }
    ...
    public String findFileExtension(String fileName) {
        ...
        return fileName.substring(index);   //substring( , ) - záró index nem kell, mert szó végéig kell menni
    }
...
//Fájlnevek kezelése
//Készítsünk egy FileNameManipulator osztályt, amely fájlnevek ellenőrzésére, illetve
//ehhez kapcsolódó String műveletekre alkalmas metódusokat tartalmaz.